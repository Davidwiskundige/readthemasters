...
This list is exhaustive: working files produced while transcribing — prepared page images,
per-page LaTeX fragments, magnification crops — live **outside** the corpus and are never committed
here. Only `figures/` crops cross that line.
