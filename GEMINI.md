...
- **DO NOT ask the user to approve a plan** or wait for confirmation before starting (unless the work or translation already exists in the corpus, in which case Phase 1 requires warning the user before re-transcribing or overwriting).
