...
%  * The formerly uncertain reading in note (i), "$Ai\ [a] :$", has been confirmed correct by a
%    reviewer; its \uncertain{} wrapper has been removed (identically here and in original.tex).
...
[Note~g] $Ai : \alpha\gamma$, or, by composition, $\alpha\gamma^{2}\ [ttzz : aa] : A\alpha^{2}\ [tt] = Ai\ [a] :
