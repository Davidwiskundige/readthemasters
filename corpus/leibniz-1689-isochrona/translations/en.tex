...
not the quantity of motion, but potentia [later called vis viva], differing from the quantity of
motion, that is conserved, a
...
\emph{Solution.} Let there be (fig.~116) any semicubical paraboloid curve $\beta Ne$ (namely, one
