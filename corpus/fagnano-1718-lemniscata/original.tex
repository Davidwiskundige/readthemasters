...
l'arco diretto $CQ = \int \dfrac{a^{2}\,dz}{\sqrt{a^{4} - z^{4}}}$, e l'arco inverso
...
(1)
\[ t = a\, \frac{\sqrt{a^{2} + z^{2}}}{\sqrt{a^{2} - z^{2}}}. \]

(2)
\[ \int \frac{a^{2}\,dz}{\sqrt{a^{4} - z^{4}}} = \int dz\, \frac{\sqrt{a^{2} + zz}}{\sqrt{a^{2} - az}} + \int \frac{t^{2}\,dt}{\sqrt{t^{4} - a^{4}}} - \frac{zt}{a}. \]
...
(3)
\[ \mathrm{Arc.}\,CQ = \mathrm{arc.}\,DI + \mathrm{arc.}\,MO = \frac{zt}{a}. \]
...
(5)
\[ \int -\frac{a^{2}\,dz}{\sqrt{a^{4} - z^{4}}} = \int -dz\, \frac{\sqrt{a^{2} + z^{2}}}{\sqrt{a^{2} - z^{2}}} + \int \frac{r^{2}\,dr}{\sqrt{r^{4} - a^{4}}} - \frac{1}{z}\sqrt{a^{4} - z^{4}}. \]
...
(6)
\[ \mathrm{Arc.}\,QA = \mathrm{arc.}\,IF + \mathrm{arc.}\,ML - \frac{1}{z}\sqrt{a^{4} - z^{4}}. \]
...
(7)
\[ u = a\, \frac{\sqrt{a^{2} - z^{2}}}{\sqrt{a^{2} + z^{2}}}. \]

(8)
\[ \int \frac{a^{2}\,dz}{\sqrt{a^{4} - z^{4}}} = \int -\frac{a^{2}\,du}{\sqrt{a^{4} - u^{4}}}. \]
